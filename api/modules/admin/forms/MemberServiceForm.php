...
use common\models\common\MemberService as Legal;
use common\models\common\MemberServiceCategory as LegalCategory;
use yii\base\Model;

class MemberServiceForm extends Model
{
    /**
     * 法律汇编分类保存
     */
    ...
    public function rules()
    {
        return [
            ...
            [['title', 'image', 'content','introduction'], 'string', 'on' => [self::SCENARIO_LEGAL_SAVE]],
